...
<body style="background: #000">
    ...
    <div class="main" style="opacity: 0;">
        ...
        <div class="main-body">
            ...
            <div class="sidebar">
                <div class="header-user-menu header-background" style="margin-top: 30px;"><h2 style="color:white; margin-left: 10px;"><span class="model-name">ALGN</span></h2>
                    <?php //include('/include/header_table.php'); ?>
                    <table class="tbl-stock-list">
                        <thead class="table-side">
                            <th>Name</th>
                            <th>Price</th>
                            <th>Change</th>
                            <th>Open</th>
        ...
        <div class="footer">
            ...
            <div class="footer-right">
                Our Company
                <br>
                Our company has an IT dev team.
                4 of team members have best and talented skills in developing apps and building sites.
